...
export default function CartContainer() {
  return (
    <div className=' fixed top-0 right-0 w-full z-50 text-white md:w-460 h-screen bg-gray-200 drop-shadow-md flex flex-col'>
      ...
      <div className=' w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col'>
        ...
        <div className=' w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2'>
          ...
          <motion.button whileTap={{ scale: 0.75 }}
            type="button"
            className=" w-full p-2 rounded-xl text-primary text-lg font-dynapuff font-medium my-2 hover:shadow-lg transition-all duration-150 ease-out bg-blue-gradient">
            Check out
          </motion.button>
